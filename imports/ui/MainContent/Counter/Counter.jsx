...
const Counter = ({increase, activeFolder}) => {
            ...
            {!activeFolder ? <div className="folders">
                ...
                {folders.length > 0 ? folders.map((folder)=> {
                    return <div key={folder._id} className="folders__row">
                        ...
                        <Link to={`/folders/${folder._id}`} className="folders__row__open">
                ...
                }) : <p className="noFolders">No folders</p>}
